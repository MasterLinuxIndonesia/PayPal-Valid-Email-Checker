...
echo ""
printf "\n";       
printf  "\e[38;5;82m   _________            _____  _______      _____       \n" 
printf  "\e[38;5;82m   \_   ___ \___.__.   /  |  | \   _  \    /  |  |      \n"
printf  "\e[38;5;82m   /    \  \<   |  |  /   |  |_/  /_\  \  /   |  |_     \n"
printf  "\e[38;5;82m   \     \___\___  | /    ^   /\  \_/   \/    ^   /     \n"
printf  "\e[38;5;82m    \______  / ____| \____   |  \_____  /\____   |      \n"
printf  "\e[38;5;82m           \/\/           |__|        \/      |__|      \n" 
printf "==============================================\n"
printf "${NC}  PayPal Script Valid Email Checker v.404         \n"
printf "${NC}       M4ST3R L1NUXS3R INDONESIA    \n"
printf "${RED}==============================================${NC}\n\n"
...
Report any bugs to:  cybernow@yahoo.com
"
  exit 1
}
...
# posted=`curl "https://ipnpb.paypal.com/cgi-bin/webscr" --data "cmd=_cart&upload=1&business=$1&item_name_1=Iyaharuuum&amount_1=12.35&shipping_1=2.45" --compressed -D - -s --cookie-jar drop.cook --cookie asu`
  posted=`curl "https://ipnpb.paypal.com/cgi-bin/webscr" --data "item_name=Sunbury$RAND.COM+-+Monthly+Email+Address&p3=1&t3=Y&cmd=_xclick-subscriptions&currency_code=AUD&sra=1&src=1&business=$1" --compressed -D - -s --cookie-jar cookiejar.txt --cookie cookie.txt`
  duration=$SECONDS
